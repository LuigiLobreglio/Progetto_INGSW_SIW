...
prefix="c" %>
    ...
    %>
            ...
            <head>
                ...
                <script type="text/javascript" src='${pageContext.request.contextPath}/js/carousel.js'>
                </script>
            ...
            <body>
                ...
                <div class="jumbotron feature">
                    <div class="container">
                        ...
                        <p>Vorresti pianificare la tua dieta, avere un carrello pronto con solo il necessario, <br> e ricevere tutto comodamente dove vuoi? Allora sei nel posto giusto!
                        </p>
                    </div>
                </div>
                    ...
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12 footer-info-item text-center">
                                ...
                                <h2>Contattaci</h2>
                                <p class="lead"><span class="glyphicon glyphicon-phone-alt"></span> +39 333 33333333<br> lbrlgu95r09g786e@studenti.unical.it
                                </p>
