...
<head>
    ...
    function mostraForm()
    {
    	$("#moduloAccesso").css("display","block");
...
<body>
 <!-- Navigation -->
	...
	<p>Accedi per la prima volta <span class="glyphicon glyphicon-hand-right"> </span></p>    
	<input class="btn btn-success" type="button"  onclick="mostraForm()" value="Accedi"/>
	
	</div>
    
    
    <div class=container>
    <form id="moduloAccesso" style="display:none" class="form-horizontal" method="post" action="../inviaCredenziali">
